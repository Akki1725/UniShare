...
public final class ItemReceiveBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView receiveBox;

  private ItemReceiveBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout marginLayout, @NonNull LinearLayout msgContainer,
      @NonNull TextView receiveBox) {
  ...
  public static ItemReceiveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.receiveBox;
      TextView receiveBox = ViewBindings.findChildViewById(rootView, id);
      if (receiveBox == null) {
        break missingId;
      }

      return new ItemReceiveBinding((ConstraintLayout) rootView, marginLayout, msgContainer,
          receiveBox);
    }
